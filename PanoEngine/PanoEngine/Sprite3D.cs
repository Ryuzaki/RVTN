...
namespace PanoEngine
{
    public class Sprite3D
    {
        ...
        private void ConstructorSprite3D(float ancho, float alto, String textureP)
        {
            ...
            _vertexBuffer = new VertexBuffer(_graphicsDevice, typeof(VertexPositionTexture), _verts.Length, BufferUsage.None);
        ...
        public void LoadContent() 
        {
            if (_texturePath != null) 
            {
                ...
                String contentPath = exePath + "\\" + PanoEngine.PEContent.RootDirectory + "\\" + _texturePath + ".xnb";
                String fsPath = exePath + "\\" + _texturePath;
                if(File.Exists(contentPath))
                {
                    _texture = PanoEngine.PEContent.Load<Texture2D>(_texturePath);
                }else
                {
        ...
        public void BeginTransitionAnimation(Texture2D texture, Effect effect) {
            ...
            TAEffect = PanoEngine.PEContent.Load<Effect>(@"Effects/TransEffect");
        }
